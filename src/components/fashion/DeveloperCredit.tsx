...
export function DeveloperWatermark() {
  return (
    ...
    >
      <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-[#c2186b]">
        {DEVELOPER_NAME}
      </p>
      <p className="text-[8px] uppercase tracking-[0.14em] text-[#e91e8c]">
        {DEVELOPER_ROLE}
      </p>
      <p className="text-[8px] tracking-wide text-[#c2186b]">{DEVELOPER_PHONE}</p>
    </div>
  );
}
...
export function DeveloperCreditFooter() {
  return (
    <div className="mx-auto mt-6 max-w-7xl border-t border-white/15 pt-4 text-center text-xs text-[#f8d0e4] md:text-left">
      ...
      <a
        ...
        className="mt-1 inline-block font-medium text-[#fde8f2] transition hover:text-white"
      >
        {DEVELOPER_PHONE}
      </a>
    </div>
